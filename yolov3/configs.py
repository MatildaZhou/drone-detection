...
YOLO_CUSTOM_WEIGHTS         = "checkpoints/yolov4-trt-FP32-416" #"checkpoints/yolov4-trt-FP32-416" # used in evaluate_mAP.py and custom model detection, if not using leave False
