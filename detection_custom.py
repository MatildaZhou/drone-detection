...
video_path   = "./IMAGES/drone.mp4"

yolo = Load_Yolo_model()
#detect_image(yolo, image_path, "./IMAGES/2_detect.jpg", input_size=YOLO_INPUT_SIZE, show=True, CLASSES=TRAIN_CLASSES, rectangle_colors=(255,0,0))
